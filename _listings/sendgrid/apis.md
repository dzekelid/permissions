...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/permissions/master/_listings/sendgrid/apis.md
...
- name: SendGrid - Add Api Keys
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/permissions/master/_listings/sendgrid/api-keys-post-openapi.md
- name: SendGrid - Add Api Keys
  x-api-slug: api-keys-post
  description: |-
    **This endpoint allows you to create a new random API Key for the user.**
