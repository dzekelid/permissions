...
- name: Google Doubleclick API Get User Role Permissions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/permissions/master/_listings/google-doubleclick/userprofiles-profileid-userrolepermissions-get.md
x-common:
