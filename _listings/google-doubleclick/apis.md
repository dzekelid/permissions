...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/permissions/master/_listings/google-doubleclick/userprofiles-profileid-accountpermissiongroups-id-get.md
x-common:
