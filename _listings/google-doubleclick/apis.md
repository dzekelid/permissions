...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/permissions/master/_listings/google-doubleclick/userprofiles-profileid-accountpermissions-get.md
x-common:
